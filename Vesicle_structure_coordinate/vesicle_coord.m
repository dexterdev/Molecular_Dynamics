...
r = 9; % radius of the sphere
xp2    = r.*cos(lambda).*cos(phi);
yp2    = r.*cos(lambda).*sin(phi);
zp2    = r.*sin(lambda);  


r = 8; % radius of the sphere
...
r = 7.8; % radius of the sphere
xp4    = r.*cos(lambda).*cos(phi);
yp4    = r.*cos(lambda).*sin(phi);
zp4    = r.*sin(lambda);  


r = 6.8; % radius of the sphere
...
fID = fopen('vesicle_rad10_apl1.8.xyz','w');
